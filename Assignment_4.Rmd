...
\noindent - **The estimated price elasticity of demand for sardines is `r tsls_price_wind$coefficients[[2]]`, which represents the percent decrease in volume of sardines sold for every 1% increase in price, using wind as an instrument.**
